...
class SemanaSanta extends JPanel {
        ...
        jbaceptar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    calenpage.semana_santa(anio);
                    int mes = calenpage.getMesSS();
                    calenpage.printMesesFestivos(mes, anio, calenpage.getDiaSS());
                    jtarea.setText(calenpage.devuelveCadena().toString());
                }
                catch (NumberFormatException index) {
                    JOptionPane.showMessageDialog(null, "   �Introduce un a�o!",
